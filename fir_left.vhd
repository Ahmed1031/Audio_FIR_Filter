...
ARCHITECTURE SYN OF fir_left IS


	COMPONENT fir_left_ast
	PORT (
		clk	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
		ast_sink_data	: IN STD_LOGIC_VECTOR (15 DOWNTO 0);
...
BEGIN
	...
	fir_left_ast_inst : fir_left_ast
	PORT MAP (
		clk  =>  clk,
		reset_n  =>  reset_n,
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="fir_left_ast" >
...
-- Retrieval info:      <PRIVATE name = "filename" value="fir_left.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: fir_left_st.v, fir_left_constraints.tcl, fir_left_ast.vhd, fir_left.vhd, fir_left_ast.vhd, fir_left.vhd;
-- IPFS_FILES: fir_left.vho;
-- =========================================================
