...
%Input Data Width:	16
%LSB Truncated bits:11
%FIR Width (Full Calculation Width Before Output Width Adjust) :   27
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = fir_left_mlab_mat (stimulation, output)
	coef_matrix=[0 0 0 0 0 0 0 -1 -4 -7 -10 -14 -16 -16 -12 -2 11 31 55 79 101 117 127 127 117 101 79 55 31 11 -2 -12 -16 -16 -14 -10 -7 -4 -1 0 0 0 0 0 0 0 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
